...
const TournamentRegistrationForm = ({ tournamentId, tournamentName, registrationType: propRegistrationType, tournamentData }: TournamentRegistrationFormProps) => {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6 max-w-2xl mx-auto">
      ...
      {/* T-shirt Size - только для участников */}
      {registrationType === 'participant' && tshirtFieldConfig.enabled && (
        <div>
          <label className="block text-sm font-poppins text-text-secondary mb-2">
      ...
      <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-4">
            ...
            <div className="space-y-2">
              ...
              <div className="relative bg-background-secondary/80 border-2 border-primary/30 rounded-xl shadow-lg shadow-primary/10">
                <input
                  type="number"
                  min="1"
                  required
                ...
                <button
                  ...
                  className="absolute left-0 top-0 bottom-0 w-11 sm:w-12 flex items-center justify-center bg-primary/10 hover:bg-primary/20 active:bg-primary/30 text-primary transition-all touch-manipulation disabled:opacity-30 disabled:cursor-not-allowed rounded-l-xl"
            ...
            <div className="space-y-2">
              ...
              <div className="relative bg-background-secondary/80 border-2 border-accent/30 rounded-xl shadow-lg shadow-accent/10">
                <input
                  type="number"
                  min="0"
                ...
                <button
                  ...
                  className="absolute left-0 top-0 bottom-0 w-11 sm:w-12 flex items-center justify-center bg-accent/10 hover:bg-accent/20 active:bg-accent/30 text-accent transition-all touch-manipulation disabled:opacity-30 disabled:cursor-not-allowed rounded-l-xl"
