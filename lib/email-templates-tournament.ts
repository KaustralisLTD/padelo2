...
export function getTournamentRegistrationEmailTemplate(data: TournamentRegistrationEmailData): string {
  ...
  const translations: Record<string, Record<string, string>> = {
    ...
    it: {
      ...
      paymentNote: 'Si prega di pagare la partecipazione almeno 15 giorni prima dell\'inizio del torneo, poiché c\'è una procedura di preparazione.',
    ...
    ca: {
      ...
      paymentNote: 'Si us plau, paga la teva participació almenys 15 dies abans de l\'inici del torneig, ja que hi ha un procediment de preparació.',
