...
export function generateSponsorshipProposalEmailHTML(data: {
  ...
  // Note: All translations are now handled automatically via Google Translate API
  // This function generates English template only, translation happens in email-translator.ts
  const siteUrl = process.env.NEXT_PUBLIC_SITE_URL || 'https://padelo2.com';
