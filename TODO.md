...
- [ ] Добавить отступ сверху на странице /admin/tournaments (чтобы кнопка "Crear Torneo" не перекрывалась языковым селектором)
- [ ] Добавить отступ сверху на странице /admin/users (чтобы кнопки не перекрывались языковым селектором)
- [ ] Проверить все страницы админки на перекрытие элементов языковым селектором
- [ ] Исправить tooltip для Entity ID - он выходит за границы таблицы (проблема с z-index/слоями)
- [ ] Исправить отступы на странице /admin/settings при свернутом левом меню (текст идет вплотную к меню)
- [ ] Исправить отступы на странице /admin/messages при свернутом левом меню
